      ...
      <div className="bg-white rounded-2xl shadow-sm border border-[#E1E3E5] w-full max-w-sm p-8">
        ...
        {!isConfigured ? (
          ...
          <div className="text-center py-2 space-y-4">
            ...
            <Link href="/admin" className="inline-block w-full py-2.5 bg-[#1D1D1F] text-white text-sm font-semibold rounded-lg hover:bg-[#424245] transition-colors">
              Go to sign in
            </Link>
          </div>
        ) : !ready ? (
          <div className="text-center py-4 space-y-2">
            ...
            <Link href="/admin" className="text-sm font-semibold text-[#1D1D1F] hover:underline underline-offset-2">
              ← Back to sign in
            </Link>
          </div>
        ) : (
