...
const DesignLab = dynamic(() => import('@/components/DesignLab'), { ssr: false })

export default function BranderRollerClient() {
    ...
    <div className="pt-[100px]">
      ...
      <div className="bg-[#F5F5F7] border-b border-[#D2D2D7] py-3 px-5">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-[#86868B]">
          <Link href="/" className="hover:text-[#1D1D1F] transition-colors">ORIC</Link>
          <span>/</span>
