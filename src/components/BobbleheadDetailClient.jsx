        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          >
            ...
            <a
              ...
              className="y2k-accent-surface y2k-shine w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 text-white text-sm font-bold rounded-full transition-all overflow-hidden"
            >
