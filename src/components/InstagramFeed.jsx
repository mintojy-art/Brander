      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between mb-12 gap-4">
          ...
          <a
            ...
            className="y2k-chrome-surface y2k-shine inline-flex items-center gap-2 px-5 py-2.5 text-[#1D1D1F] text-sm font-semibold rounded-full transition-all self-start overflow-hidden"
          >
