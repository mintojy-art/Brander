              ...
              {items.length === 0 ? (
                <div className="flex flex-col items-center justify-center h-full text-center py-16">
                  <div className="y2k-chrome-surface w-16 h-16 rounded-full flex items-center justify-center mb-4">
                    <Y2kIcon emoji="🛒" size={32} className="text-[#1D1D1F]" />
                  </div>
            ...
            {items.length > 0 && (
              <div className="px-6 py-5 border-t border-[#D2D2D7] space-y-3">
                ...
                <button
                  ...
                  className="y2k-accent-surface y2k-shine w-full py-3.5 text-white text-sm font-semibold rounded-xl transition-all flex items-center justify-center gap-2 overflow-hidden"
                >
