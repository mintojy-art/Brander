      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 py-16 border-b border-[#D2D2D7]">
          ...
          <div className="md:col-span-2">
            <div className="mb-4">
              <img src="/oriclogo1.svg" alt="ORIC" className="h-10 w-auto" style={{ display: 'block' }} />
            </div>
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#1D1D1F] hover:bg-[#424245] text-white text-sm font-medium rounded-full transition-all"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center w-10 h-10 bg-[#1D1D1F] hover:bg-[#424245] text-white rounded-full transition-all"
